...
-- | Factorization cutoff (Note: if this is <= 0, complete factorization is always attempted)
crFactCutoff = (10 :: Integer) ^ (80 :: Int) 

crTrialDivCutoff      = 100000

-- | use this as the higher cutoff if the number is beyond the factorization cutoff
crSmallFactCutoff     = 10000000 
